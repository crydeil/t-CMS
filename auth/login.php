            ...
            <div class="span5">		
                ...
                if (!empty($_POST))
                {
                    ...
                    if ($query->num_rows == 1)
                    {
                        ...
                        {
                            die('Такой логин с паролем не найдены в базе данных. <a href="' . BASE_URL . '/auth/login">Попробовать ещё раз</a>.');
                        }
                        
                    }
                    else
                    {
                        die('Пользователь с таким логином не найден. <a href="' . BASE_URL . '/auth/login">Попробовать ещё раз</a>.');
                    }
                ...
                echo '<form action="" method="post">
                        ...
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-user"></i></span><input type="text" class="input-xlarge" name="login" placeholder="Ваш логин" />
                        </div>
                        <p></p>
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-key"></i></span><input type="password" class="input-xlarge" name="password" placeholder="Ваш пароль" />
                        </div>
                        <p></p>
